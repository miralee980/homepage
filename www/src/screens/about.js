					...
					<div className="section">
						<div className="about_wrap">
							...
							<div className="about_txt right">
								<p>
									개별 기업의 재무데이터를 분석한 주식 투자전략, 자산배분에
									기초한 ETF 및 펀드 투자전략을 필두로 자산관리 앱 “머니포트”와
									기존 은행, 증권사를 판매 채널로 한 금융투자 상품과 서비스를
									고객에게 제공하고 있습니다. 또한 직접 로보 어드바이저를 만들
									수 있는 “아이라”를 사용하여 PB나 일반인이 직접 자산 배분 금융
									투자 상품과 서비스를 개발하고 판매할 수 있는 마켓플레이스를
									목표로 확장해 나가고 있습니다. 자산관리 앱 머니포트,
									로보어드바이저 개발 솔루션 아이라, 그리고 무인점포 솔루션
									큐오스크는 자산관리를 갈망하는 모든 사람이 투자금액에 차별
									없이 양질의 서비스를 쉽고 편리한 자산관리가 모두의 일상으로
									자리 잡게 만들고 있습니다.
								</p>
							</div>
						</div>
						...
						<div className="value_wrap">
							<ul className="value_list">
								...
								<li className="value_item">
									...
									/>
									<p className="value_txt">
										더 단순한, 더 편리한, <br className="value_br" />더 쉬운
										것을 추구합니다.
									</p>
								</li>
							</ul>
